...
console.log("PROGRAM: Personal Introduction Output "); 
...
*/ 
let message = "This is a string assigned to variable called message";  // End of statement with semicolon 
console.log(message);                 
// Output: Comments Are Used to Explain Code 